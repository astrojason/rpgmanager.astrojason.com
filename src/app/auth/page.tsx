    ...
    <div style={{ minHeight: "100%", display: "flex", alignItems: "center", justifyContent: "center", padding: "36px 56px" }}>
      <div className="grim-tome is-bordered" style={{ width: "100%", maxWidth: 420 }}>
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          ...
          <h2 style={{ fontFamily: "var(--font-display)", fontSize: "3rem", color: "var(--grim-gold)", margin: 0, lineHeight: 1 }}>
            {mode === "signin" ? "A Summoning" : "Inscribe Thyself"}
          </h2>
          <div style={{ fontFamily: "var(--font-body)", fontSize: "1.0833rem", color: "var(--grim-ink-3)", fontStyle: "italic", marginTop: 6 }}>
        ...
        <form onSubmit={handleEmailAuth} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <input
            ...
            style={{
              ...
              color: "var(--grim-ink)", fontFamily: "var(--font-body)", fontSize: "1.25rem",
          ...
          />
          {error && <div style={{ color: "var(--grim-blood-2)", fontSize: "1.0833rem", fontFamily: "var(--font-mono)" }}>{error}</div>}
          <button type="submit" disabled={loading} className="grim-btn is-ember" style={{ justifyContent: "center", padding: "12px 14px", fontSize: "1.0833rem" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "16px 0" }}>
          ...
          <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.8333rem", color: "var(--grim-ink-4)", letterSpacing: ".14em", textTransform: "uppercase" }}>or</span>
          <div className="grim-rule" style={{ margin: 0, flex: 1 }}/>
        </div>
        ...
        <div style={{ marginTop: 16, textAlign: "center" }}>
          <button
            type="button"
            className="grim-link"
            style={{ background: "none", border: "none", cursor: "pointer", fontFamily: "var(--font-head)", fontSize: "1.0833rem", letterSpacing: ".08em" }}
