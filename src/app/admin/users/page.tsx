    ...
    <div style={{ padding: "36px 48px 80px" }}>
      ...
      <header style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 24, marginBottom: 28 }}>
        <div>
          ...
          <h1 className="grim-page-title" style={{ fontSize: "6.4444rem" }}>User Management</h1>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14 }}>
          ...
          <div className="grim-tome" style={{ padding: "20px 22px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
              <span style={{ fontFamily: "var(--font-display)", fontSize: "2.8889rem", color: "var(--grim-blood-2)" }}>⚙</span>
              <span style={{ fontFamily: "var(--font-head)", fontSize: "1.6667rem", letterSpacing: ".08em", textTransform: "uppercase", color: "var(--grim-ink)" }}>Administrator</span>
            </div>
            <span className="grim-chip is-blood" style={{ marginBottom: 10 }}>admin</span>
            <p style={{ fontFamily: "var(--font-body)", fontSize: "1.4444rem", color: "var(--grim-ink-3)", margin: "10px 0 0" }}>Full system access</p>
          </div>

          {/* DM */}
          <div className="grim-tome" style={{ padding: "20px 22px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
              <span style={{ fontFamily: "var(--font-display)", fontSize: "2.8889rem", color: "var(--grim-ember)" }}>⚔</span>
              <span style={{ fontFamily: "var(--font-head)", fontSize: "1.6667rem", letterSpacing: ".08em", textTransform: "uppercase", color: "var(--grim-ink)" }}>Dungeon Master</span>
            </div>
            <span className="grim-chip is-ember" style={{ marginBottom: 10 }}>dm</span>
            <p style={{ fontFamily: "var(--font-body)", fontSize: "1.4444rem", color: "var(--grim-ink-3)", margin: "10px 0 0" }}>Enhanced campaign access</p>
          </div>

          {/* Player */}
          <div className="grim-tome" style={{ padding: "20px 22px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
              <span style={{ fontFamily: "var(--font-display)", fontSize: "2.8889rem", color: "var(--grim-moss)" }}>⚑</span>
              <span style={{ fontFamily: "var(--font-head)", fontSize: "1.6667rem", letterSpacing: ".08em", textTransform: "uppercase", color: "var(--grim-ink)" }}>Player</span>
            </div>
            <span className="grim-chip is-alive" style={{ marginBottom: 10 }}>player</span>
            <p style={{ fontFamily: "var(--font-body)", fontSize: "1.4444rem", color: "var(--grim-ink-3)", margin: "10px 0 0" }}>Standard user access</p>
          </div>
      ...
      <section>
        <h2 className="grim-h-section">
          ...
          {usersWithCharacters.length > 0 && (
            <span style={{ fontFamily: "var(--font-display)", fontSize: "2.2222rem", color: "var(--grim-gold)", marginLeft: 12, fontWeight: "normal", letterSpacing: ".08em" }}>
        ...
        {loading && usersWithCharacters.length === 0 ? (
          <div className="grim-tome" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 14, padding: "48px 28px" }}>
            ...
            <span style={{ fontFamily: "var(--font-body)", fontSize: "1.6667rem", color: "var(--grim-ink-3)" }}>Consulting the registry…</span>
          </div>

        /* Empty state */
        ) : usersWithCharacters.length === 0 ? (
          <div className="grim-tome" style={{ textAlign: "center", padding: "56px 28px" }}>
            <div style={{ fontFamily: "var(--font-display)", fontSize: "5.7778rem", color: "var(--grim-ink-4)", marginBottom: 14 }}>⊕</div>
            <div style={{ fontFamily: "var(--font-head)", fontSize: "1.7778rem", letterSpacing: ".10em", textTransform: "uppercase", color: "var(--grim-ink-3)", marginBottom: 8 }}>No souls registered</div>
            <div style={{ fontFamily: "var(--font-body)", fontSize: "1.5556rem", color: "var(--grim-ink-4)" }}>No users are currently recorded in the Scriptorium.</div>
          </div>
                ...
                >
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
                    <div style={{
                      ...
                      fontFamily: "var(--font-display)", fontSize: "1.5556rem",
                    ...
                    <div style={{ minWidth: 0 }}>
                      <div style={{ fontFamily: "var(--font-head)", fontSize: "1.5556rem", letterSpacing: ".04em", color: "var(--grim-ink)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                        {user.displayName || "Unknown"}
                      </div>
                      <div className="grim-mono" style={{ fontSize: "1.2222rem", color: "var(--grim-ink-3)", letterSpacing: ".08em", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                        {user.email}
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    {isEditing ? (
                      ...
                      <span style={{ fontFamily: "var(--font-body)", fontSize: "1.4444rem", color: user.assignedCharacter ? "var(--grim-ink-2)" : "var(--grim-ink-4)" }}>
                        {charName}
                      </span>
                    )}
                  </div>
                  ...
                  {/* Last sign-in */}
                  <div className="grim-mono" style={{ fontSize: "1.2222rem", color: "var(--grim-ink-4)", letterSpacing: ".08em" }}>
                    ...
                    {isEditing ? (
                      <>
                        ...
                        <button
                          ...
                          style={{ padding: "6px 12px", fontSize: "1.2222rem", color: "var(--grim-blood-2)", borderColor: "var(--grim-blood-2)" }}
                        >
                          Cancel
                        </button>
                      </>
