    ...
    <div style={{ padding: "36px 48px 80px" }}>
      ...
      <header style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 24, marginBottom: 28 }}>
        <div>
          ...
          <h1 className="grim-page-title" style={{ fontSize: "3.625rem" }}>Factions</h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "280px 1fr", gap: 24 }}>
        ...
        <div className="grim-tome" style={{ padding: 0, overflow: "hidden" }}>
          <div style={{ padding: "12px 16px", borderBottom: "1px solid var(--grim-line)" }}>
            <div style={{ fontFamily: "var(--font-head)", fontSize: "0.8125rem", letterSpacing: ".08em", textTransform: "uppercase", color: "var(--grim-ink-2)", marginBottom: 10 }}>
              ...
              return (
                ...
                >
                  <div style={{ minWidth: 0, flex: 1 }}>
                    <div style={{ fontFamily: "var(--font-head)", fontSize: "0.875rem", color: selected ? "var(--grim-ember-2)" : "var(--grim-ink-2)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {faction.name}
                    </div>
                    ...
                    <div className="grim-mono" style={{ fontSize: "0.625rem", color: "var(--grim-ink-4)", marginTop: 2, textTransform: "uppercase", letterSpacing: ".10em" }}>
                      {faction.status}
                    </div>
                    {faction.hidden && <span className="grim-chip is-dead" style={{ fontSize: "0.5625rem", marginTop: 4 }}>hidden</span>}
                  </div>
                  <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
                    <button
                      className="grim-link"
                      onClick={(e) => { e.stopPropagation(); handleEdit(faction); }}
                      style={{ fontSize: "0.6875rem", fontFamily: "var(--font-mono)", letterSpacing: ".08em", textTransform: "uppercase", background: "none", border: "none", cursor: "pointer", padding: "2px 4px" }}
                      title="Edit"
                    >
                      edit
                    </button>
                    <button
                      ...
                      style={{ fontSize: "0.6875rem", fontFamily: "var(--font-mono)", letterSpacing: ".08em", textTransform: "uppercase", background: "none", border: "none", cursor: "pointer", padding: "2px 4px", color: "var(--grim-blood-2)" }}
                      title="Delete"
                    >
                      del
                    </button>
          ...
          {(isCreating || isEditing) ? (
            ...
            <div className="grim-tome" style={{ padding: 0, overflow: "hidden" }}>
              <div className="grim-tome-head" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16 }}>
                <div className="grim-tome-title" style={{ fontFamily: "var(--font-display)", fontSize: "2.25rem", color: "var(--grim-gold)", letterSpacing: ".04em" }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                      {selectedFaction.pronunciation && (
                        <div style={{ fontFamily: "var(--font-mono)", fontSize: "0.75rem", color: "var(--grim-ink-3)", letterSpacing: ".14em" }}>
                          [{selectedFaction.pronunciation}]
                        </div>
                      )}
                      ...
                      {selectedFaction.relationships.map((rel, index) => (
                        ...
                        >
                          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
                            <span style={{ fontFamily: "var(--font-head)", fontSize: "0.875rem", color: "var(--grim-ink-2)" }}>{rel.faction}</span>
                          ...
                          {rel.description && (
                            <div style={{ marginTop: 6, fontFamily: "var(--font-body)", fontSize: "0.8125rem", color: "var(--grim-ink-3)" }}>{rel.description}</div>
                          )}
                        </div>
                      ))}
                    </div>
            ...
            <div className="grim-tome" style={{ textAlign: "center", padding: "60px 24px" }}>
              ...
              <div style={{ fontFamily: "var(--font-head)", fontSize: "1rem", letterSpacing: ".08em", textTransform: "uppercase", color: "var(--grim-ink-2)", marginBottom: 8 }}>No banner selected</div>
              <div style={{ color: "var(--grim-ink-4)", fontSize: "0.875rem" }}>Select a faction from the list to view, or raise a new one.</div>
            </div>
          )}
        </div>
