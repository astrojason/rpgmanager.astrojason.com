  ...
  if (loading) {
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "64px 0" }}>
        ...
        <span style={{ marginLeft: 12, fontFamily: "var(--font-body)", color: "var(--grim-ink-3)", fontSize: "1.5556rem" }}>Loading Calendar...</span>
      </div>
    );
  }
    ...
    <div style={{ padding: "36px 48px 80px" }}>
      ...
      <header style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 24, marginBottom: 28 }}>
        <div>
          ...
          <h1 className="grim-page-title" style={{ fontSize: "6.4444rem" }}>Calendar</h1>
      ...
      <div className="grim-tome" style={{ padding: "16px 20px", marginBottom: 24, display: "flex", alignItems: "center", gap: 24, flexWrap: "wrap" }}>
        <div>
          ...
          {calendarData?.current ? (
            <div>
              <div style={{ fontFamily: "var(--font-display)", fontSize: "2.4444rem", color: "var(--grim-gold)" }}>
              ...
              <div className="grim-mono" style={{ fontSize: "1.1111rem", color: "var(--grim-ink-4)", letterSpacing: ".14em", marginTop: 2 }}>
                Tyr&apos;amryn Year {calendarData.current.year + AB_OFFSET}
              </div>
            </div>
          ) : (
            <div style={{ color: "var(--grim-ink-4)", fontFamily: "var(--font-body)", fontSize: "1.5556rem" }}>Not set</div>
          )}
        </div>
        {!editingDate && (
          <button
            className="grim-btn is-ghost"
            style={{ padding: "6px 14px", fontSize: "1.4444rem" }}
            onClick={() => {
        ...
        <div className="grim-tome" style={{ padding: 0, overflow: "hidden" }}>
          ...
          <div style={{ overflowY: "auto", maxHeight: "calc(100vh - 280px)" }}>
            {filteredEvents.length === 0 ? (
              <div style={{ padding: "32px 16px", textAlign: "center", fontFamily: "var(--font-body)", fontSize: "1.5556rem", color: "var(--grim-ink-4)" }}>
