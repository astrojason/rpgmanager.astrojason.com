  ...
  if (loading) {
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "64px 0" }}>
        ...
        <span style={{ marginLeft: 12, fontFamily: "var(--font-body)", color: "var(--grim-ink-3)", fontSize: "1.1667rem" }}>Loading Calendar...</span>
      </div>
    );
  }
      ...
      <div className="grim-tome" style={{ padding: "16px 20px", marginBottom: 24, display: "flex", alignItems: "center", gap: 24, flexWrap: "wrap" }}>
        <div>
          ...
          {calendarData?.current ? (
            <div>
              <div style={{ fontFamily: "var(--font-display)", fontSize: "1.8333rem", color: "var(--grim-gold)" }}>
              ...
              <div className="grim-mono" style={{ fontSize: "0.8333rem", color: "var(--grim-ink-4)", letterSpacing: ".14em", marginTop: 2 }}>
                Tyr&apos;amryn Year {calendarData.current.year + AB_OFFSET}
              </div>
            </div>
          ) : (
            <div style={{ color: "var(--grim-ink-4)", fontFamily: "var(--font-body)", fontSize: "1.1667rem" }}>Not set</div>
          )}
        </div>
        {!editingDate && (
          <button
            className="grim-btn is-ghost"
            style={{ padding: "6px 14px", fontSize: "1.0833rem" }}
            onClick={() => {
        ...
        <div className="grim-tome" style={{ padding: 0, overflow: "hidden" }}>
          ...
          <div style={{ overflowY: "auto", maxHeight: "calc(100vh - 280px)" }}>
            {filteredEvents.length === 0 ? (
              <div style={{ padding: "32px 16px", textAlign: "center", fontFamily: "var(--font-body)", fontSize: "1.1667rem", color: "var(--grim-ink-4)" }}>
                ...
                >
                  <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8 }}>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div className="grim-mono" style={{ fontSize: "0.8333rem", color: "var(--grim-ink-4)", marginTop: 3 }}>
