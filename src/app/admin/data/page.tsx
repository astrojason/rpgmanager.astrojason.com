  ...
  return (
    <div style={{ padding: "36px 48px 80px" }}>
      <header style={{ marginBottom: 28 }}>
        ...
        <h1 className="grim-page-title" style={{ fontSize: "6.4444rem" }}>Tomes of Record</h1>
          ...
          <Link key={type.href} href={type.href} style={{ textDecoration: "none", color: "inherit", display: "block" }}>
            <div className="grim-tome" style={{ padding: "20px 22px", cursor: "pointer", display: "flex", gap: 16, alignItems: "center" }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontFamily: "var(--font-head)", fontSize: "1.6667rem", letterSpacing: ".06em", textTransform: "uppercase", color: "var(--grim-ink)" }}>{type.name}</div>
                <div className="grim-mono" style={{ fontSize: "1.1111rem", letterSpacing: ".12em", color: "var(--grim-ink-3)", textTransform: "uppercase", marginTop: 3 }}>{type.sub}</div>
              </div>
              <span style={{ color: "var(--grim-ink-4)", fontFamily: "var(--font-display)", fontSize: "2.2222rem" }}>›</span>
            </div>
          </Link>
        ))}
      </div>
