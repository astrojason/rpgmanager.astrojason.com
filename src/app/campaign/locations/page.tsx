  ...
  return (
    <div style={{ padding: "36px 56px 80px", height: "100%", overflowY: "auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 22 }}>
        ...
        <div className="grim-mono" style={{ fontSize: "0.6875rem", color: "var(--grim-ink-3)", letterSpacing: ".18em", textAlign: "right", textTransform: "uppercase" }}>
            ...
            <div className="grim-tome" style={{ padding: 0, overflow: "hidden" }}>
              ...
              <div style={{ position: "relative", height: 140, background: "var(--grim-bg-3)" }}>
                <div className="grim-img-slot" style={{ width: "100%", height: "100%", borderRadius: 0 }}>
                  <div style={{ fontFamily: "var(--font-display)", fontSize: "0.6875rem", color: "var(--grim-ink-4)", letterSpacing: ".14em", textTransform: "uppercase" }}>no image on file</div>
                </div>
                ...
                <div style={{ position: "absolute", bottom: 10, left: 14, right: 36 }}>
                  <div className="grim-mono" style={{ fontSize: "0.5625rem", color: "var(--grim-ember-2)", letterSpacing: ".22em", textTransform: "uppercase" }}>
                    location
                  </div>
                  <div style={{ fontFamily: "var(--font-display)", fontSize: "1.5rem", color: "var(--grim-gold)", lineHeight: 1.1, marginTop: 2 }}>{selectedArea.name}</div>
                </div>
                <button
                  onClick={handleCloseDetail}
                  style={{ position: "absolute", top: 8, right: 8, background: "oklch(0.12 0.025 290 / 0.85)", border: "1px solid var(--grim-line)", color: "var(--grim-ink-3)", cursor: "pointer", padding: "2px 7px", fontFamily: "var(--font-mono)", fontSize: "0.8125rem", lineHeight: 1 }}
                >
                  ×
                </button>
              </div>
              ...
              <div style={{ padding: "14px 18px 18px" }}>
                {selectedArea.pronunciation && (
                  <div className="grim-mono" style={{ fontSize: "0.625rem", color: "var(--grim-ink-3)", letterSpacing: ".14em", marginBottom: 8 }}>
                    pronounced {selectedArea.pronunciation}
                  </div>
                )}
                <p style={{ fontSize: "0.8125rem", color: "var(--grim-ink-2)", lineHeight: 1.5, margin: "0 0 12px" }}>
                  {selectedArea.teaser}
                </p>
        ...
        <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
            {sublocations.map((location) => (
              ...
              >
                <div style={{ fontFamily: "var(--font-display)", fontSize: "1.25rem", color: "var(--grim-gold)", lineHeight: 1, letterSpacing: ".01em", marginBottom: 5, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                  {location.name}
                </div>
                {location.pronunciation && (
                  <div className="grim-mono" style={{ fontSize: "0.5625rem", color: "var(--grim-ink-4)", letterSpacing: ".12em", marginBottom: 6 }}>
                    {location.pronunciation}
                  </div>
                )}
                {location.teaser && (
                  <div style={{ fontSize: "0.75rem", color: "var(--grim-ink-2)", lineHeight: 1.4, display: "-webkit-box", WebkitLineClamp: 3, WebkitBoxOrient: "vertical" as const, overflow: "hidden" }}>
                    {location.teaser}
                  </div>
                )}
              </div>
