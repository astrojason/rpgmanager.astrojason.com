        ...
        <section>
          ...
          {sortedItems.length === 0 ? (
            <div style={{ textAlign: "center", padding: "48px 24px", color: "var(--grim-ink-4)" }}>
              <div style={{ fontFamily: "var(--font-display)", fontSize: "2.6667rem", color: "var(--grim-ink-3)" }}>~ the vaults are empty ~</div>
              ...
              {sortedItems.map(item => (
                ...
                >
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                    <span className="grim-chip" style={{ fontSize: "0.75rem", padding: "2px 7px", ...categoryChipStyle(item.category) }}>
                      {item.category || "Item"}
                    </span>
                  </div>
                  <div style={{ fontFamily: "var(--font-display)", fontSize: "1.8333rem", color: "var(--grim-gold)", lineHeight: 1, letterSpacing: ".01em" }}>
                    {item.name}
                  </div>
                  {item.pronunciation && (
                  ...
                  {item.type_tag && (
                    <div style={{ fontFamily: "var(--font-body)", fontStyle: "italic", fontSize: "1rem", color: "var(--grim-ink-3)", marginTop: 4 }}>
                      {item.type_tag}
                    </div>
                  )}
                  {item.description && (
