...
export default function TimelinePage() {
  ...
  return (
    <div style={{ padding: "36px 56px 80px", overflowY: "auto", height: "100%", maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ position: "relative", flex: 1, minWidth: 240 }}>
          <input
            ...
            style={{
              ...
              color: "var(--grim-ink)", fontFamily: "var(--font-body)", fontSize: "1rem",
      ...
      <div className="grim-mono" style={{ fontSize: "0.625rem", letterSpacing: ".18em", color: "var(--grim-ink-3)", textTransform: "uppercase", marginBottom: 28 }}>
      ...
      {isCreating && (
        <div className="grim-tome" style={{ marginBottom: 32, padding: "22px 26px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            {createError && (
              <div className="grim-mono" style={{ fontSize: "0.6875rem", color: "var(--grim-blood-2)", letterSpacing: ".12em" }}>{createError}</div>
            )}
      ...
      {filtered.length === 0 ? (
        <div style={{ textAlign: "center", padding: "60px 24px", color: "var(--grim-ink-4)" }}>
          <div style={{ fontFamily: "var(--font-display)", fontSize: "2.25rem", color: "var(--grim-ink-3)", marginBottom: 8 }}>~ no events found ~</div>
                    ...
                    {isEditing && editingEvent ? (
                      <div className="grim-tome" style={{ padding: "22px 26px" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                          ...
                          {editError && (
                            <div className="grim-mono" style={{ fontSize: "0.6875rem", color: "var(--grim-blood-2)", letterSpacing: ".12em" }}>{editError}</div>
                          )}
                          <div style={{ display: "flex", justifyContent: "flex-end", gap: 8 }}>
                      ...
                      <div className="grim-tome" style={{ padding: "18px 22px" }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, marginBottom: 10 }}>
                          <div style={{ minWidth: 0 }}>
                            <div className="grim-mono" style={{ fontSize: "0.625rem", letterSpacing: ".18em", color: "var(--grim-ink-4)", textTransform: "uppercase", marginBottom: 4 }}>
                              {event.date}
                            </div>
                            <h3 style={{ fontFamily: "var(--font-display)", fontSize: "1.625rem", color: "var(--grim-gold)", margin: 0, lineHeight: 1.1 }}>
                              {event.title}
                            </h3>
                          </div>
                          <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
                            {event.category && (
                              <span style={{
                                fontFamily: "var(--font-mono)", fontSize: "0.625rem", letterSpacing: ".14em",
                            ...
                            {canEdit && (
                              <div style={{ display: "flex", gap: 6 }}>
                                <button className="grim-btn is-ghost" style={{ padding: "4px 10px", fontSize: "0.6875rem" }} onClick={() => handleStartEdit(event)}>
                                  Edit
                                </button>
                                <button
                        ...
                        {/* Description */}
                        {event.description && (
                          <div className="prose prose-sm dark:prose-invert max-w-none" style={{ fontSize: "0.875rem", color: "var(--grim-ink-2)", lineHeight: 1.65 }}>
                        ...
                        {isDM && event.gm_notes && event.gm_notes.trim() && event.gm_notes.trim().toLowerCase() !== "null" && (
                          <div style={{ marginTop: 14, paddingTop: 12, borderTop: "1px dashed var(--grim-line)" }}>
                            ...
                            <div className="prose prose-sm dark:prose-invert max-w-none" style={{ fontSize: "0.8125rem", color: "var(--grim-ink-3)", lineHeight: 1.55 }}>
