      ...
      <section style={{ display: "flex", gap: 12, alignItems: "stretch", marginBottom: 22, flexWrap: "wrap" }}>
        ...
        {uniqueTypes.length > 1 && (
          <select
            ...
            style={{ background: "var(--grim-bg-3)", border: "1px solid var(--grim-line-2)", color: typeFilter ? "var(--grim-ink)" : "var(--grim-ink-4)", fontFamily: "var(--font-body)", fontSize: "0.875rem", padding: "12px 14px", outline: "none", cursor: "pointer" }}
          >
      ...
      <section>
        ...
        {sorted.length === 0 ? (
          <div style={{ textAlign: "center", padding: "48px 24px", color: "var(--grim-ink-4)" }}>
            <div style={{ fontFamily: "var(--font-display)", fontSize: "2rem", color: "var(--grim-ink-3)" }}>~ no banners found ~</div>
            ...
            {sorted.map((faction) => (
              ...
              >
                ...
                <div style={{ position: "relative", height: 80 }}>
                  ...
                  <div style={{ position: "absolute", top: 8, left: 10, fontFamily: "var(--font-display)", fontSize: "1.375rem", color: "var(--grim-gold)" }}>
                    {getFactionCrest(faction.type)}
                  </div>
                  <div style={{ position: "absolute", top: 8, right: 8 }}>
                    <span className={statusChipClass(faction.status)} style={{ fontSize: "0.5625rem", padding: "2px 6px" }}>
                ...
                <div style={{ padding: "10px 14px 14px" }}>
                  <div style={{ fontFamily: "var(--font-display)", fontSize: "1.25rem", color: "var(--grim-gold)", lineHeight: 1.1, letterSpacing: ".01em" }}>
                    {faction.name}
                  </div>
                  <div className="grim-mono" style={{ fontSize: "0.5625rem", color: "var(--grim-ink-4)", letterSpacing: ".14em", textTransform: "uppercase", marginTop: 3 }}>
