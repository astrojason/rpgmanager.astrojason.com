    ...
    return (
      <div style={{ padding: "36px 56px 80px" }}>
        ...
        <div style={{ marginTop: 32, textAlign: "center", color: "var(--grim-ink-4)" }}>
          <div style={{ fontFamily: "var(--font-display)", fontSize: "2rem", color: "var(--grim-ink-3)" }}>~ soul not found ~</div>
          <div className="grim-mono" style={{ fontSize: "0.6875rem", letterSpacing: ".18em", textTransform: "uppercase", marginTop: 8 }}>No record of this soul in the codex</div>
        </div>
      </div>
    );
  }
          ...
          >
            ...
            >
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                ...
                <div>
                  <label style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.625rem", letterSpacing: ".18em", textTransform: "uppercase", color: "var(--grim-ink-3)", marginBottom: 6 }}>Gender</label>
                  <select
              ...
              <div>
                <label style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.625rem", letterSpacing: ".18em", textTransform: "uppercase", color: "var(--grim-ink-3)", marginBottom: 6 }}>Background</label>
              ...
              <div>
                <label style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.625rem", letterSpacing: ".18em", textTransform: "uppercase", color: "var(--grim-ink-3)", marginBottom: 6 }}>Roleplaying Notes</label>
              ...
              <div style={{ display: "flex", gap: 20 }}>
                {[
                  ...
                  <label key={field} style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer", fontFamily: "var(--font-head)", fontSize: "0.8125rem", color: "var(--grim-ink-2)", letterSpacing: ".04em" }}>
                    <input
                      type="checkbox"
              ...
              <div>
                <label style={{ display: "block", fontFamily: "var(--font-mono)", fontSize: "0.625rem", letterSpacing: ".18em", textTransform: "uppercase", color: "var(--grim-ink-3)", marginBottom: 6 }}>Linked NPCs</label>
                <input
                  type="text"
                  placeholder="Filter souls…"
                  value={linkedNpcSearch}
                  onChange={(e) => setLinkedNpcSearch(e.target.value)}
                  style={{ width: "100%", background: "var(--grim-bg-3)", border: "1px solid var(--grim-line-2)", borderBottom: "none", color: "var(--grim-ink)", fontFamily: "var(--font-body)", fontSize: "0.8125rem", padding: "6px 10px", outline: "none" }}
                />
                      ...
                      return (
                        <label key={n.id} style={{ display: "flex", alignItems: "center", gap: 8, padding: "3px 0", cursor: "pointer" }}>
                          <input
                            ...
                            style={{ accentColor: "var(--grim-ember)" }}
                          />
                          <span style={{ fontFamily: "var(--font-body)", fontSize: "0.875rem", color: "var(--grim-ink-2)" }}>{label}</span>
                        </label>
                      );
                    })}
                </div>
      ...
      <div style={{ padding: "36px 56px 80px", height: "100%", overflowY: "auto" }}>
            ...
            {hasValidImage(npc.image) ? (
              ...
              >
                ...
                <div style={{ position: "absolute", bottom: 10, left: 10, right: 10, padding: "5px 9px", background: "oklch(0.10 0.02 290 / 0.75)", border: "1px solid var(--grim-gold-2)", display: "flex", justifyContent: "space-between" }}>
                  <span className="grim-mono" style={{ fontSize: "0.5625rem", letterSpacing: ".18em", color: "var(--grim-gold)", textTransform: "uppercase" }}>portrait · click to enlarge</span>
                  <span className="grim-mono" style={{ fontSize: "0.625rem", color: "var(--grim-ink-3)" }}>↗</span>
                </div>
              </div>
            ) : (
              <div className="grim-img-slot is-portrait" style={{ width: 280, height: 360, border: "1px solid var(--grim-gold-2)" }}>
                <div>
                  <div style={{ fontFamily: "var(--font-display)", fontSize: "2.25rem", color: "var(--grim-ink-4)" }}>?</div>
                  <div style={{ marginTop: 8, fontSize: "0.625rem", letterSpacing: ".18em", textTransform: "uppercase", color: "var(--grim-ink-4)" }}>no likeness on file</div>
                </div>
              </div>
            )}
            <div style={{ position: "absolute", top: -10, left: -10, transform: "rotate(-5deg)" }}>
              <div className="grim-seal" style={{ width: 48, height: 48, fontSize: "1.125rem" }}>✦</div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", paddingTop: 4 }}>
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <h1 style={{ fontFamily: "var(--font-display)", fontSize: "4.5rem", color: "var(--grim-gold)", margin: "2px 0 4px", lineHeight: 0.9, letterSpacing: ".01em", textShadow: "0 0 36px oklch(0.72 0.165 48 / 0.22)" }}>
                  {displayName(npc) || "Unknown"}
                </h1>
                {isNameHidden(npc) && dmMode && (
                  <span className="grim-chip" style={{ fontSize: "0.625rem", flexShrink: 0, background: "oklch(0.25 0.10 78 / 0.85)", color: "var(--grim-gold-2)", border: "1px solid var(--grim-gold-2)" }}>name hidden from players</span>
                )}
              </div>
              ...
              {npc.aka && !isNameHidden(npc) && (
                <div style={{ fontFamily: "var(--font-body)", fontStyle: "italic", color: "var(--grim-ink-3)", fontSize: "0.9375rem", marginTop: 3 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", marginTop: 22, borderTop: "1px solid var(--grim-line)", borderBottom: "1px solid var(--grim-line)", padding: "12px 0" }}>
              {[
                ...
                <div key={k} style={{ paddingLeft: i === 0 ? 0 : 16, borderLeft: i === 0 ? "none" : "1px solid var(--grim-line)" }}>
                  ...
                  <div style={{ fontFamily: "var(--font-display)", fontSize: "1.25rem", color: "var(--grim-gold)", lineHeight: 1.15, marginTop: 3 }}>{v}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        {npc.description && (
          <section className="grim-parchment" style={{ marginBottom: 28 }}>
            <div style={{ margin: 0, fontSize: "1.0625rem", lineHeight: 1.65, color: "oklch(0.25 0.03 50)" }}
          ...
          <div className="grim-stack" style={{ gap: 22 }}>
            {npc.background && (
              <section className="grim-tome">
                ...
                <div className="prose dark:prose-invert max-w-none prose-sm" style={{ color: "var(--grim-ink-2)", fontFamily: "var(--font-body)", fontSize: "0.9375rem", lineHeight: 1.65 }} dangerouslySetInnerHTML={{ __html: renderMarkdownWithLinks(npc.background || "", isAdmin, autoLinkEntities) }} />
              </section>
            )}
            {(isDM || isAdmin) && npc.roleplaying_notes && (
              <section className="grim-tome" style={{ border: "1px solid oklch(0.65 0.150 285 / 0.35)", background: "linear-gradient(180deg, oklch(0.16 0.04 285 / 0.4), oklch(0.13 0.03 290 / 0.25))" }}>
                ...
                <div className="prose dark:prose-invert max-w-none prose-sm" style={{ color: "var(--grim-ink-2)", fontFamily: "var(--font-body)", fontSize: "0.9375rem", lineHeight: 1.65 }} dangerouslySetInnerHTML={{ __html: renderMarkdownWithLinks(npc.roleplaying_notes || "", isAdmin, autoLinkEntities) }} />
              </section>
            )}
            {!npc.background && (!(isDM || isAdmin) || !npc.roleplaying_notes) && (
              <section className="grim-tome" style={{ border: "1px dashed var(--grim-line-2)", textAlign: "center", padding: "28px 24px", color: "var(--grim-ink-4)" }}>
                ...
                <div className="grim-mono" style={{ fontSize: "0.6875rem", letterSpacing: ".18em", textTransform: "uppercase", marginTop: 4 }}>No further record in the codex</div>
              </section>
            )}
          </div>
              ...
              dmMode ? (
                npc.gm_notes ? (
                  <section className="grim-tome" style={{ border: "1px solid var(--grim-arcane)", background: "linear-gradient(180deg, oklch(0.18 0.05 285), oklch(0.13 0.04 290))" }}>
                    ...
                    <div className="prose dark:prose-invert max-w-none prose-sm" style={{ color: "var(--grim-ink)", fontFamily: "var(--font-body)", fontSize: "0.875rem", lineHeight: 1.6 }} dangerouslySetInnerHTML={{ __html: renderMarkdownWithLinks(npc.gm_notes || "", true) }} />
                  </section>
                ) : isAdmin ? (
                    ...
                    <Link key={d.id} href={`/campaign/deities/${d.id}`} style={{ textDecoration: "none", color: "inherit", display: "block" }}>
                      <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: 8, padding: "6px 0", borderBottom: "1px dashed var(--grim-line)" }}>
                        <span style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
                          ...
                          {d.hidden && dmMode && <span className="grim-chip is-blood" style={{ fontSize: "0.5625rem", padding: "1px 6px" }}>hidden</span>}
                        </span>
                ...
                <section className="grim-tome">
                  ...
                  <div className="grim-stack" style={{ gap: 8 }}>
                    {linkedNpcs.map(linked => (
                      <Link key={linked.id} href={`/campaign/npcs/${linked.id}`} style={{ textDecoration: "none", color: "inherit", display: "block" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "6px 0", borderBottom: "1px dashed var(--grim-line)" }}>
                          ...
                          <div>
                            <div style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
                              <div style={{ fontFamily: "var(--font-head)", fontSize: "0.8125rem", color: "var(--grim-gold)", letterSpacing: ".03em" }}>{displayName(linked)}</div>
                              {linked.hidden && dmMode && <span className="grim-chip is-blood" style={{ fontSize: "0.5625rem", padding: "1px 6px" }}>hidden</span>}
                              {isNameHidden(linked) && dmMode && <span className="grim-chip" style={{ fontSize: "0.5625rem", padding: "1px 6px", background: "oklch(0.25 0.10 78 / 0.85)", color: "var(--grim-gold-2)", border: "1px solid var(--grim-gold-2)" }}>name hidden</span>}
                            </div>
                            {linked.race && <div className="grim-mono" style={{ fontSize: "0.625rem", color: "var(--grim-ink-4)", letterSpacing: ".10em" }}>{linked.race}</div>}
                          </div>
                        </div>
                      </Link>
                    ))}
