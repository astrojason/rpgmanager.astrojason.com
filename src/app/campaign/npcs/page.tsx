        ...
        <section>
                ...
                >
                  ...
                  <div style={{ position: "relative", aspectRatio: "1 / 1" }}>
                    ...
                    <div style={{ position: "absolute", top: 7, left: 7, display: "flex", flexDirection: "column", gap: 3 }}>
                      <span className={statusChipClass(npc.status)} style={{ fontSize: "0.5625rem", padding: "2px 6px" }}>{npc.status || "Unknown"}</span>
                      {npc.hidden && (isDM || isAdmin) && (
                        <span className="grim-chip" style={{ fontSize: "0.5625rem", padding: "2px 6px", background: "oklch(0.25 0.06 285 / 0.85)", color: "var(--grim-arcane)", border: "1px solid var(--grim-arcane)" }}>hidden</span>
                      )}
                    </div>
                  </div>
                  ...
                  <div style={{ padding: "10px 12px 12px", display: "flex", flexDirection: "column", justifyContent: "flex-start" }}>
                    <div style={{ display: "flex", alignItems: "baseline", gap: 6, minWidth: 0 }}>
                      ...
                      {isNameHidden(npc) && (isDM || isAdmin) && (
                        <span className="grim-chip" style={{ fontSize: "0.5625rem", padding: "2px 6px", flexShrink: 0, background: "oklch(0.25 0.10 78 / 0.85)", color: "var(--grim-gold-2)", border: "1px solid var(--grim-gold-2)" }}>name hidden</span>
                      )}
                    </div>
                    ...
                    <div className="grim-mono" style={{ fontSize: "0.5625rem", color: "var(--grim-ink-3)", letterSpacing: ".14em", textTransform: "uppercase", marginTop: 3, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                    ...
                    {npc.description && (
                      <div
                        ...
                        style={{ fontSize: "0.75rem", color: "var(--grim-ink-2)", lineHeight: 1.4, marginTop: 7, display: "-webkit-box", WebkitLineClamp: 3, WebkitBoxOrient: "vertical", overflow: "hidden" }}
                    ...
                    {(isDM || isAdmin) && npc.roleplaying_notes && (
                      <div style={{ marginTop: 6, paddingTop: 6, borderTop: "1px dashed oklch(0.65 0.150 285 / 0.25)" }}>
                        <div
                          ...
                          style={{ fontSize: "0.6875rem", color: "oklch(0.70 0.12 285)", lineHeight: 1.4, display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" }}
          ...
          {totalPages > 1 && (
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 10, marginTop: 22 }}>
              ...
              <span className="grim-mono" style={{ fontSize: "0.6875rem", letterSpacing: ".14em", color: "var(--grim-ink-3)", textTransform: "uppercase" }}>
