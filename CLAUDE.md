...
3. Progress is recorded:
   - **TODO.md** — every bug, feature, and enhancement must have an entry here. Before starting work, check if it's already listed. If it isn't, add it. Check off the item when done (e.g. `- [x] Stage 1 — Project Scaffold`); create the file if it doesn't exist.
