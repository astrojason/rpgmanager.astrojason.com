...
3. Progress is recorded:
   - **TODO.md** — every bug, feature, and enhancement must have an entry here. Before starting work, check if it's already listed. If it isn't, add it. Remove the item once the work has been committed — the git log is the record; create the file if it doesn't exist.
